# ============================================================
# Student page — minimal static file server
# Byte-for-byte copy of ../Students/serve.ps1 with the port
# range shifted to 8002-8012 so it doesn't collide with the
# Students static server (8000-8010).
# ============================================================
